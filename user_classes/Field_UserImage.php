...
class Field_UserImage extends Field {
	...
	public function display() {
		...
		echo "&nbsp;<a href='" . Config::$uripath . "/art/imagedragdrop/show?filter=upload' target='_blank' type='button' id='trigger_image_upload_{$this->id}' class='button btn is-small is-info is-light'>Upload New Image</a>";
